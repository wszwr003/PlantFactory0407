...
export class CollectPage implements OnInit {
  public url_history:string = '/water-history';
  public lineChartData: ChartDataSets[] = [
    { data: [15, 17, 29, 33, 37, 25, 16], label: '液温(℃)', yAxisID: 'y-axis-1' },
    { data: [28, 48, 40, 19, 86, 27, 90], label: '电导率(%)', yAxisID: 'y-axis-0' },
    { data: [1800, 480, 770, 900, 1000, 2700, 4000], label: 'PH', yAxisID: 'y-axis-2' },
    { data: [180, 480, 770, 90, 1000, 270, 400], label: '液位(cm)', yAxisID: 'y-axis-3' }
  ];
